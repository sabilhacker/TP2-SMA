...
to reproduce-warewalves  ; wolf procedure
 if random-float 100 < warewalves-reproduce [  ; throw "dice" to see if you will reproduce
   set energy (energy / 2)               ; divide energy between parent and offspring
   hatch 1 [ rt random-float 360 fd 1 ]  ; hatch an offspring and move it forward 1 step
 ]
end
...
"vampires" 1.0 0 -8630108 true "" "plot count vampires"
"deadly-weeds" 1.0 0 -7858858 true "" "plot count deadly-weeds"
